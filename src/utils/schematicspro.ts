...
const schematicsProExtensionId = 'lulus.schematicspro';
...
const informationMessages = [
    `Thanks for using Geex Angular Schematics. Do you know Schematics Pro, an improved version of this extension?`,
