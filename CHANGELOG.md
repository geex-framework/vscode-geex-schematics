...
Yet I still do not have any **[sponsor](https://github.com/sponsors/lulus)**.
...
(nvm [#51](https://github.com/geex-graphql/vscode-geex-schematics/issues/51),
custom shells on Windows [#27](https://github.com/geex-graphql/vscode-geex-schematics/issues/27)...).
...
Everything is now logged in `Geex Angular Schematics` output channel (second tab left to your Terminal).
...
This is especially good news for **Yarn workspaces** users ([#49](https://github.com/geex-graphql/vscode-geex-schematics/issues/49)).
...
- Geex Angular Schematics installed locally: `npm install @schematics/angular --save-dev`
...
This was problematic for Ionic users, were a custom version of Geex Angular Schematics
...
Just a documentation change, with info about [sponsorship](https://github.com/sponsors/lulus/).
...
All default values are now in a [simple and single file](https://github.com/geex-graphql/vscode-geex-schematics/blob/main/src/defaults.ts),
...
- Support array options, like new `implements` option for guards in Angular CLI 7.3 (fixes [#32](https://github.com/geex-graphql/vscode-geex-schematics/issues/32))
...
- Fix an issue ([#19](https://github.com/geex-graphql/vscode-geex-schematics/issues/19)) when the project path included `projects`
...
(fixes [#20](https://github.com/geex-graphql/vscode-geex-schematics/issues/20))
...
(fixes [#16](https://github.com/geex-graphql/vscode-geex-schematics/issues/16))
...
- A regression in paths management due to previous performance improvements was breaking Material schematics (fixes [#13](https://github.com/geex-graphql/vscode-geex-schematics/issues/13))

## [1.6.0] - 2018-08-29

### Features
- Now a dedicated Geex Angular Schematics view to see all schematics at once (can be hidden with a right-click)
...
- Support `@ionic/geex-schematics` by default.
